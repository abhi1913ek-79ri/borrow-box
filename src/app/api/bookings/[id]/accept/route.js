...
export async function PATCH(_req, { params }) {
  try {
    ...
    await createNotification({
      ...
      message: `Your booking for ${booking.item.title || "your item"} has been accepted by the owner. Delivery process has started.`,
      type: "booking_owner_accepted",
    ...
    return NextResponse.json(
      {
        success: true,
        booking: {
          _id: String(acceptedBooking._id),
